...
DEFAULT_COANA_CLI_VERSION: Final = "15.9.9"
...
class ReachabilityAnalyzer:
    ...
    def _resolve_coana_package_spec(self, version: Optional[str] = None) -> str:
        """
        Resolve the @coana-tech/cli package spec to run (e.g. '@coana-tech/cli@15.9.9').
        ...
        Returns:
            str: The package specifier to use with npx (e.g. '@coana-tech/cli@15.9.9').
        """
