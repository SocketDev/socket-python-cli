...
### Changed: bump pinned @coana-tech/cli to 15.4.5

- Bumped the pinned reachability engine (`@coana-tech/cli`) from `15.3.24` to
  `15.4.5`. See the [Coana changelogs](https://docs.coana.tech/changelogs) for
  engine changes.
